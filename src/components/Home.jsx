...
const Home = () => {
    ...
    return (
        <div>
            <div className="block max-w-sm gap-2 mx-auto sm:max-w-full mt-20 group hover:no-underline focus:no-underline lg:mb-28 lg:grid lg:grid-cols-12 dark:bg-gray-100">
